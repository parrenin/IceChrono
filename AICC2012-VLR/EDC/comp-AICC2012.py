...
mpl.plot(f(IC_depth),IC_age-f(IC_depth), color='k', label='IceChrono')
...
mpl.ylabel('IceChrono - AICC2012 ice age difference (yr)')
...
mpl.figure('Gas Age')
mpl.fill_between(f(IC_depth),-g(IC_depth),+g(IC_depth), color='0.8')
mpl.plot(f(IC_depth),IC_gage-f(IC_depth), color='k', label='IceChrono')
...
mpl.ylabel('IceChrono - AICC2012 gas age difference (yr)')
mpl.xlabel('AICC2012 age (yr b1950)') 
x1,x2,y1,y2 = mpl.axis()
mpl.axis((0, 800000, -6000, 6000))
mpl.legend()

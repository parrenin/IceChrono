...
f=interpolate.interp1d(self.depth,self.iedepth, bounds_error=False, fill_value=self.iedepth[-1]) #We should not need the bounds_error option. Check what is the problem.
